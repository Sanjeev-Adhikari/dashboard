...
const Header = () => {
    ...
    return ( 
        ...
        <div className="flex items-center relative gap-4">
          <span className="absolute px-2 "><Image src="/images/search.png" alt="search-image" width={16} height={16} /></span>
          <input
            type="text"
          ...
          <div className="absolute right-0 mt-2 w-36 bg-white border  border-gray-200 rounded-md shadow-lg">
            <ul className="py-1">
              ...
              <li>
                ...
                >
                    <img src="/images/logout.png" alt="profile-logout" className="w-4" />
                  Logout
                </Link>
              </li>
            </ul>
